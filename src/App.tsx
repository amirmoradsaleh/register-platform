                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="bg-white p-4 rounded-xl border border-slate-150 shadow-sm text-right">
                      ...
                      <h5 className="text-xl font-black text-rose-600 mt-1">
                                  ...
                                  <td className="px-4 py-3.5 text-center">
                                    <div className="inline-flex items-center gap-1.5">
                                      <button
                                        ...
                                        className="p-1 px-2 text-[10px] font-bold bg-indigo-50 text-indigo-700 hover:bg-indigo-100 rounded-md transition-all flex items-center gap-1 cursor-pointer"
                                        title="ویرایش وضعیت پرونده"
                                      >
